...
CKEDITOR.replace('editor', {
    ...
    extraPlugins: 'codeblock,pastefromword,pastetools,table',
    ...
    extraAllowedContent: 'body(font-size);p(font-size);div(font-size);span(font-size);code(font-family);pre(font-family);pre(background-color);pre(border);pre(padding);pre(border-radius);table{*}(*)[*];tr{*}(*)[*];td{*}(*)[*];th{*}(*)[*];thead;tbody;tfoot;colgroup;col{*}(*)[*]',
