...
CKEDITOR.replace('editor', {
    ...
    extraAllowedContent: 'body(font-size);p(font-size);div(font-size);span(font-size);code[*];pre(font-family);pre(background-color);pre(border);pre(padding);pre(border-radius);table{*}(*)[*];tr{*}(*)[*];td{*}(*)[*];th{*}(*)[*];thead;tbody;tfoot;colgroup;col{*}(*)[*]',
